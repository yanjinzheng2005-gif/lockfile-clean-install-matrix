...
- Test-presence guard: PASS, 5 files and 17 declarations.
...
- npm/pnpm ignore-scripts and pnpm ignore-pnpmfile assertions: PASS.
...
1. npm pass fixture: baseline PASS, candidate PASS, overall NO_REGRESSION.
2. pnpm pass fixture: baseline PASS, candidate PASS, overall NO_REGRESSION.
...
5. Packaged Action produces the same npm pass result.
6. Every normal, failed, and timed-out container is removed.
